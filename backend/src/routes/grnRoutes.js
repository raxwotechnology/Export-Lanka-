...
import { createGrn, getGrns, getGrnById, updateGrn, approveGrnQA, sendGrnSmsManually } from '../controllers/grnController.js';
...
router.route('/:id')
    .get(requirePermission('grn.manage'), getGrnById)
    .put(requirePermission('grn.manage'), updateGrn);
